...
public:
    ...
    boolean fahrstrasseEinstellenOpt(Gleissymbol *start, Gleissymbol *ziel);                              /**<TestPhase: Einstellen einer optimalen Fahrstraße, zum Biespiel be mehreren Fahrstraßen*/
