...
public:
    ...
    int wegSuchenOpt(Gleissymbol *start, Gleissymbol * ziel, Gleissymbol * vorgaenger = nullptr, int laenge = 0);         /**<(in der entwicklung) Die Methode ermittelt den Optimalen Weg, sollten mehr als zwei Wege existieren*/
    ...
    boolean fahrstrasseEinstellenOpt(Gleissymbol *start, Gleissymbol *ziel);                              /**<(in der Entwicklung) Einstellen einer optimalen Fahrstraße, zum Biespiel be mehreren Fahrstraßen*/
