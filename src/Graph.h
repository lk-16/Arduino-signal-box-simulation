...
public:
    ...
    Gleissymbol* sucheFlankenschutzweiche(int vorgaenger, int weiche, int nachfolger, int tiefe);
    ...
    boolean weichenAusgang(int vorgaenger, int aktuellerKnoten);                                          /**<Kommt die Fahrstraße über einen Weichenausgang auf die Weiche false, über den Eingang, also den Teil über den man zwei Abzweige weiter fahren kann, dann true*/
};
#endif