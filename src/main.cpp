...
*/
  ...
  //FTÜ-Melder
  if (zugtaste1.getzugtastenstatus() == HIGH || zugtaste2.getzugtastenstatus() == HIGH || zugtaste3.getzugtastenstatus() == HIGH || zugtaste4.getzugtastenstatus() == HIGH)    //wenn eine Zugtaste gedrückt ist
  {
