...
*/
  ...
  boolean besetztmelderAuslesen(boolean besetztmelderBeleuchtung, class WeichenControl WeichenControl);          /**<Auslesen des Besetztmelders, aktueller Status wird zurückgegeben und die Anzeige je nach Einstellung in besetztmelderLicht und fahrstrassenelement geschaltet*/
  ...
  void setWeichenLeds(int weichenNr, int newLedGerade, int newLedKurve);                   /**<wechselt die Weichen Led für Besetztmelder, um über den Spitzenmelder die Besetztmeldung anzuzeigen.*/
};
